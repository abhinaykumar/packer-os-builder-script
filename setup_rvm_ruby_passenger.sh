...
# ## Install and setup passenger to run on standalone mode
# gem install passenger --no-rdoc --no-ri

# ## To restart passenger at the time of reboot
# sudo chmod +x /etc/rc.local
# sudo sed -i '4s#$# cd /home/ubuntu/videoken/current#g' /etc/rc.local
# sudo sed -i '5s/$/ bundle exec passenger start/g' /etc/rc.local
